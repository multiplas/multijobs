		...
		public function envato_setup_introduction() {
			...
			if ( false && isset( $_REQUEST['debug'] ) ) {
				...
				<div class="notification closeable notice">
					...
					<p>WorkScout is based on <a target="_blank" href="https://wpjobmanager.com">WP Job Manager</a> and it's add-ons. The free version of WP Job Manager allows for listing jobs and job submissions, if you want to have resumes, application, bookmarks, job alerts and other features you can see on a demo, the best way would be to buy the Core Add-on Bundle. It is available <a target="_blank" href="https://wpjobmanager.com/add-ons/bundle/"> here</a>
					</p>
					<p>
