 ...
 */
function reneva_header_class( $class = '' ) {
	// Separates classes with a single space, collates classes for body element
	echo 'class="' . join( ' ', reneva_get_header_class( $class ) ) . '"';
}


function reneva_get_header_class( $class = '' ) {
	global $wp_query;
	 ...
	 */
	$classes = apply_filters( 'reneva_header_class', $classes, $class );
