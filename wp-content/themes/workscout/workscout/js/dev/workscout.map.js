(function ( $ ) {
	...
	if(wsmap.geocode){
				$("#search_location:not(.search_region)").geocomplete().bind("geocode:result", function(event, result){
			  	...
			  	$("#candidate_location,#job_location").geocomplete();
...
// single map
	...
	function initJobMap() {
	    ...
	    var myLatLng = {lng: $( '#job_map' ).data('longitude'),lat: $( '#job_map' ).data('latitude'), };
	    var sigle_zoom = parseInt(wsmap.single_zoom);
