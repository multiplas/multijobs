...
<!-- fin navegacion -->
  ...
  <div class="main container">
   <h1 class="page-heading3 title_font">Contacto</h1>
    <div class="row">
      <div class="col-md-12">
        <h4>¿Tiene alguna duda o sugerencia? ¡No dude en consultarnos! </h4>
        <?php
          if(isset($_SESSION['enviado'])){
            if($_SESSION['enviado']==1){
               echo '<div class="alert alert-success" role="alert">Correo enviado con éxito. Le responderemos en la mayor brevedad posible.</div>';
            }
            else{
               echo '<div class="alert alert-danger" role="alert">El envio de correo ha fallado. Por favor, inténtelo de forma manual a la siguiente dirección: javierdiazrego@hotmail.com</div>';
            }
            unset($_SESSION['enviado']);
          }
        ?>
        <br>
        <form role="form" action="enviarcorreo.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="mail" class="form-control" id="ejemplo_email_1" name ="mail" placeholder="Introduzca su email" required>
          </div> 
          <div class="form-group">
            <label for="asunto">Asunto</label>
            <input type="text" class="form-control" id="asunto" name="asunto" placeholder="Asunto de la consulta" required>
          </div>
          <div class="form-group">
            <label for="cuerpo">Cuerpo</label>
            <textarea maxlength="300" id="cuerpo" name="cuerpo" class="form-control" rows="3" placeholder="Motivo de la consulta. Límite 300 caracteres." required></textarea>
          </div>
