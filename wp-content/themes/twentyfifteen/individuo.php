  ...
  <div class="main container">
   <div class="row">
		...
		<div class="hidden-sm col-md-3 col-lg-2">
			<button id="atras" type="button" class="boton_header button btn btn-default" onclick="location.href = 'ver-alumnos'">
              <span>
      ...
      <div class="col-md-12">
      	...
      	// recogemos la id del anuncio
			$id_individuo = $_GET["individuo"];

			$consulta1 = "SELECT * FROM `alumno` WHERE idalumno = $id_individuo";
      $consulta2 = "SELECT nombre_familia, nombre_ciclo, nombre_fp FROM familias, fp, ciclo, alumno_ciclo where ciclo.idciclo = alumno_ciclo.ciclo AND fp.id_fp = alumno_ciclo.fp AND familias.id_familia = alumno_ciclo.familia AND idalumno = $id_individuo";
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-5">
        <?php 
        if(empty($vitae))echo "<p style='color:red;'>Lo sentimos, el alumno no dispone de curriculum.</p>";
        else echo "<a href='descargar.php?archivo=$vitae' ><img id='imagen_curri' onmouseout='quitarhover(this.id)' onmouseover='hover(this.id)' class='descargar_curri' src='img/pdf-icon.png' alt='descargar_curriculum'/></a>";
        ?>
      </div>
      <div class="hidden-xs col-md-1"></div>
        <div class="col-md-5">
