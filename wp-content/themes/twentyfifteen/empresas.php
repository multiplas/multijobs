...
?>
	<div class="main container">
		<div class="row">
		<h1 class="page-heading title_font col-md-9 col-lg-10">Autentificación Empresa</h1>
		...
		<div class="col-xs-12 col-sm-12 col-md-6">
			<form action="registro_empresa.php" method="post" id="create-account_form" class="box">
		...
		<div class="col-xs-12 col-sm-12 col-md-6">
			...
			<form action="inicia_empresa.php" method="post" id="login_form" class="box">
