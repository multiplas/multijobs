    ...
    <div class="row">
      ...
      <div class="col-md-12">
      	<div class="col-xs-12 col-sm-6 col-lg-4">
	  		<ul>
				<li><a class="perfil2" href="info_personal.php"><i class="fa fa-3x fa-fw fa-user text-inverse icono2"></i> INFORMACIÓN PERSONAL</a></li>
				<li><a class="perfil2" href="mensajes.php"><i class="fa fa-3x fa-fw fa-envelope text-inverse icono2"></i>MENSAJES</a></li>
      <?php if(isset($_SESSION['id_empresa'])){ ?>
        <li><a class="perfil2" href="anuncios_publicados.php"><i class="fa fa-3x fa-fw fa-envelope text-inverse icono2"></i>Anuncios publicados</a></li>
          <?php } ?>
			</ul>
      	</div>
      </div>
