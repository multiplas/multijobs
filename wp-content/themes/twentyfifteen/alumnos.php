...
<head>
	...
	<script>
		function redimensiona(){
			elementos = document.querySelectorAll('[class="main container"]');
			if(window.innerWidth>991){
				resultado = window.innerHeight - 100;
				elementos[0].style.height = resultado +"px";
			}
			else{
				elementos[0].style.height ="";
			}
...
?>
	<div class="main container">
		...
		<div class="hidden-sm col-md-3 col-lg-2">
			<button id="atras" type="button" class="boton_header button btn btn-default" onclick="location.href = 'index.php'">
              <span>
		...
		<div class="col-xs-12 col-sm-12 col-md-6">
			<form action="registro_alumno" method="post" id="create-account_form" class="box">
		...
		<div class="col-xs-12 col-sm-12 col-md-6">
			<form action="inicia_alumno.php" method="post" id="login_form" class="box">
